...
CREATE TABLE `comments` (
  ...
  `post_id` varchar(100) collate utf8_general_ci NOT NULL default '',
  `name` varchar(100) collate utf8_general_ci NOT NULL default '',
  `comment` varchar(100) collate utf8_general_ci NOT NULL default '',
...
CREATE TABLE `posts` (
  ...
  `body` varchar(100) collate utf8_general_ci NOT NULL default '',
  `create_dt_tm` datetime NOT NULL default '0000-00-00 00:00:00',
  PRIMARY KEY  (`post_id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci; 
